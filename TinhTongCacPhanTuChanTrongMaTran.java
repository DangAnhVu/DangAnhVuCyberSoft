...
public class TinhTongCacPhanTuChanTrongMaTran {
	...
	public static void TinhTongSoChan(int[][] a, int m, int n) {
		int sum = 0;
		for(int i=0;i<m;i++) {
			for(int j=0;j<n;j++) {
				if(a[i][j] %2 == 0) {
		...
		System.out.println("Tổng của các giá trị số chẵn trong mảng 2 chiều là: "+ sum);
	}
